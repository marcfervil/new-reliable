/**
 * This is the base class for the front end that holds and manages the canvas, and tools. 
 */
...
class Reliable {
    ...
    /** @returns {Tool} current tool that is selected in the tool bar*/
    getCurrentTool(){
    ...
    /**
     * This function should be called once in the start. Make sure to add the tool you made otherwise it won't appear in the bar
     * @param {tool} tool that you are adding 
     */
    addTool(tool){
    ...
    /**this function takes in a state array.  It goes through and creates SVGs based on each state JSON in the array 
     * @param {array} state array of json containing the states. json generated by calling serialize() on svg
    */
    setState(state){
        //console.log(state);
        ...
        for(let svgData of state){
            ...
            svg.transform.scale = new Vector2(svgData.scale.x, svgData.scale.y);

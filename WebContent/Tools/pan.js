...
class Pan extends Tool{
    ...
    constructor(){
        ...
        document.addEventListener('keydown', (event)=> {
            if(event.key === 'f'){
                ...
                let mouseOffset = mousePos.subtract(new Vector2(cx, cy)).subtract(center);
              ...
              //  console.log(dist);
                ...
                let panOffset = new Vector2(deltaX, deltaY);
                let offset = mousePos.add(panOffset);

                let deltaPan = offset.subtract(mousePos);

                this.pan(offset, true);
                console.log(deltaPan);
                this.pan(deltaPan)*/
    ...
    pan(delta, hard){
        ...
        canvas.setAttribute("viewBox", `${pan.x} ${pan.y} ${canvas.clientWidth} ${canvas.clientHeight}`);*/
